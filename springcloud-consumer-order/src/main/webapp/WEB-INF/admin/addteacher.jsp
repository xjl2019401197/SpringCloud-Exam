                ...
                <div class="layui-col-sm11">
                    <div class="layui-form-item" style="padding: 10px">
                        ...
                        <div class="layui-input-block">
                            <input name="Name" id="Name" lay-verify="required" class="layui-input">
                    ...
                    <div class="layui-form-item" style="padding: 10px">
                        ...
                        <div class="layui-input-block">
                            <input class="layui-input" id="Password" name="Password" lay-verify="required">
                        </div>
                    </div>
                    <div class="layui-form-item" style="padding: 10px">
                    ...
                    <div class="layui-form-item" style="padding: 10px">
                        ...
                        <div class="layui-input-block" style="width: 380px">
                            <input name="Email" id="Email" class="layui-input" lay-verify="required">
                        </div>
                    </div>
...
<script>
    layui.use(['form', 'laydate', 'layer', 'upload'], function () {
        ...
        form.on('submit(ok)', function (data) {
            $.post(
                '${pageContext.request.contextPath}/insertteacher',//ajax请求
                $("#form").serialize(),//携带数据
                function (result) {//回调函数，根据返回结果进行相应的操作
                    if (result.code == 0) {
                        layer.msg('教师添加成功', {icon: 6, time: 1000}, function () {//使用Jquery弹层组件，自动关闭
                            var index = parent.layer.getFrameIndex(window.name); //先得到当前iframe层的索引
                            parent.layer.close(index); //再执行关闭
                        })
                    } else {
                        layer.msg('教师已存在', {icon: 5, time: 1000}, function () {//使用Jquery弹层组件，自动关闭

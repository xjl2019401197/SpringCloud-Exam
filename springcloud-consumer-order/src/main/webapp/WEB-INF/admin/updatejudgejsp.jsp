        ...
        <div class="layui-row">
            <div class="layui-col-sm8">
                ...
                <div class="layui-col-sm11">
                    ...
                    <input type="hidden" name="id" class="hidden" value="${judge.id}">
                    <input type="hidden" name="type" class="hidden" value="${judge.type}">
                    <div class="layui-form-item" style="padding: 10px">
                        <label class="layui-form-label">题目:</label>
                        <div class="layui-input-block">
                            <textarea rows="2" cols="50" lay-verify="required" autofocus  id="Content"
                                      name="Content">${judge.content}</textarea>
                    ...
                    <div class="layui-form-item" style="padding: 10px">
                        ...
                        <div class="layui-input-block" style="width: 380px">
                            <select id="Difficulty" name="Difficulty">
                                <option>${judge.difficulty}</option>
...
<script>
    layui.use(['form', 'laydate', 'layer', 'upload'], function () {
        ...
        form.on('submit(ok)', function (data) {
            $.post(
                '${pageContext.request.contextPath}/updatejudge',//ajax请求
                $("#form").serialize(),//携带数据
                function (result) {//回调函数，根据返回结果进行相应的操作
                    if (result.code == 0) {
                        layer.msg('题目修改成功', {icon: 6, time: 1000}, function () {//使用Jquery弹层组件，自动关闭

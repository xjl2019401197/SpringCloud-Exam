                ...
                <div class="layui-col-sm11">
                    ...
                    <div class="layui-form-item" style="padding: 10px">
                        ...
                        <div class="layui-input-block" style="width: 380px">
                             <span style="margin-left: 20px;margin-right: 10px">A</span> <input type="checkbox" name="Answer"  value="A">
...
<script>
    layui.use(['form','laydate', 'layer','upload'], function () {
        ...
        form.on('submit(ok)', function (data) {
            $.post(
                '${pageContext.request.contextPath}/insertmultipleChoice',//ajax请求
                $("#form").serialize(),//携带数据

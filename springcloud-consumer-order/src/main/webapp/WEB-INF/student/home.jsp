...
<div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<%=basePath%>/examlist?token=<%=token%>" target="frame">
                            <i class="fa fa-gear fa-fw"></i>考试</a>
                    </li>
                    <li>
                        <a href="<%=basePath%>/histoty?Stuid=<%=token%>" target="frame">
    ...
    <div id="page-wrapper" style="width: 83.5%;height: 700px;background-color: white">
        <iframe name="frame" style="width: 100%;height: 700px;background-color: white;border: black"></iframe>
    </div>

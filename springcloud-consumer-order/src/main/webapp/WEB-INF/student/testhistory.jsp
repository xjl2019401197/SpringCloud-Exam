                ...
                <c:forEach items="${choicelist}" var="ch" varStatus="status">
                    <form class="layui-form">
                        <fieldset>
                            ...
                            <input class="layui-form-radio" type="radio" name="Select${status.index}" value="A"/>A: ${ch.a}<br/>
                            <input class="layui-form-radio" type="radio" name="Select${status.index}" value="B"/>B: ${ch.b}<br/>
                            <input class="layui-form-radio" type="radio" name="Select${status.index}" value="C"/>C: ${ch.c}<br/>
                            <input class="layui-form-radio" type="radio" name="Select${status.index}" value="D"/>D: ${ch.d}<br/>
                            <br/>
                            <div style="margin-bottom: 20px;font-size: larger">正确答案: <span name="Select${status.index}" style="color: green;"></span></div>
                        </fieldset>
                    </form>
                </c:forEach>
                ...
                <c:forEach items="${judgelist}" var="ju" varStatus="status">
                    <form class="layui-form">
                        <fieldset>
                            ...
                            <br/>
                            <div style="margin-bottom: 20px;font-size: larger">正确答案: <span name="Judge${status.index}" style="color: green;"></span></div>
                        </fieldset>
                    </form>
                </c:forEach>
